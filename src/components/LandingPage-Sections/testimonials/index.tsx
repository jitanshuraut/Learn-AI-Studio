...
function Testimonials() {
  return (
    <div className="relative flex h-full w-[97%] overflow-hidden flex-col items-center justify-center  rounded-lg border bg-background py-20 md:shadow-xl">
      <h1 className="text-7xl text-[#8678F9] text-center font-headingAlt font-bold">
        Testimonials
      </h1>
      <div className="w-[97%] overflow-hidden">
